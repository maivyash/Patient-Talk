                            ...
                            complaints.map((complaint, idx) => (
                                <div key={complaint._id} className="complaint-box">
                                    ...
                                    {complaint.responses.map((r, qIdx) => (
                                        <div key={qIdx} className="complaint-question" style={{ marginBottom: "15px", padding: "10px", background: "#f9f9f9", borderRadius: "8px" }}>
                                            <p className="question-text" style={{ fontWeight: "bold", color: "#1c6e73", marginBottom: "8px" }}>
                                                Q{qIdx + 1}. {questions.find(q => String(q._id) === String(r.questionId))?.text || "Question text unavailable"}
                                            </p>
                                            {/* TEXT */}
                                            {r.answerType === "text" && (
